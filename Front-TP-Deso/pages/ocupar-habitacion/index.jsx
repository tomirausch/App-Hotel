...
export default function OcuparHabitacion() {
  ...
  const [reservasAcumuladas, setReservasAcumuladas] = useState([]); // Aquí guardamos las habitaciones a ocupar
          ...
          <div className={styles.formularioReservaContainer}>
            <div className={styles.cardFormulario}>
                ...
                <div className={styles.formReservaInputsContainer}>
                    ...
                    <div className={styles.filaInputs}>
                        <div className={styles.inputContainer}>
                            <label>Nombre*</label>
                            <input type="text" name="nombre" className={errores.Nombre ? styles.inputError : ''} 
                        ...
                        <div className={styles.inputContainer}>
                            ...
                            <input type="text" name="apellido" className={errores.Apellido ? styles.inputError : ''} 
                                onInput={(e) => e.target.value = e.target.value.toUpperCase()} 
                    ...
                    <div className={styles.filaInputs}>
                        ...
                        <div className={styles.inputContainer}>
                            ...
                            <input type="text" name="numeroDocumento" className={errores.NumeroDocumento ? styles.inputError : ''} 
                    ...
                    <div className={styles.inputContainer}>
                        ...
                        <input type="text" name="telefono" className={errores.NumeroTelefono ? styles.inputError : ''} 
                            onInput={soloNumeros} onChange={() => setErrores({ ...errores, NumeroTelefono: null })} 
                        />
                ...
                <div className={styles.botonesListaContainer} style={{marginTop:'30px', marginBottom:'0'}}>
                    ...
                    <input type="submit" form="formDatosHuesped" value={cargando ? "Procesando..." : "Confirmar Ocupación"} 
